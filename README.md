...
<ul className="list-disc pl-6 mb-6">
  <li>I am exploring Next.js for building fast and scalable web applications.</li>
  <li>I’m working on improving my front-end skills with React and Tailwind CSS to create dynamic and responsive designs.</li>
  <li>I am improving my backend skills with Node.js and MongoDB to work on full-stack applications.</li>
</ul>
